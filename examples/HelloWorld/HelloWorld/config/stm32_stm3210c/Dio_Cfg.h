...
// Channels
#define DioConf_DioChannel_LED1 16
#define Dio_LED1 DioConf_DioChannel_LED1
#define DioConf_DioChannel_LED2 17
#define Dio_LED2 DioConf_DioChannel_LED2
#define DioConf_DioChannel_LED3 30
#define Dio_LED3 DioConf_DioChannel_LED3
#define DioConf_DioChannel_LED4 31
...
// Ports
#define DioConf_DioPort_LED_PORT (uint32)(DIO_PORT_B)
